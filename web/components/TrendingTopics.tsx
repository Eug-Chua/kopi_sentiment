...
export function TrendingTopics({ topics }: TrendingTopicsProps) {
  if (!topics || topics.length === 0) {
    return (
      <div className="bg-zinc-900/50 rounded-lg p-4 border border-zinc-800 flex items-center justify-center">
          ...
          <div key={i} className="flex items-start gap-3">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 mb-1">
                <span className="text-sm text-white font-medium truncate max-w-[180px]" title={topic.topic}>
                  {topic.topic}
                </span>
